...
public class ChessGameCmdLine implements Observer{
	...
	public void go() {
		...
		//chessGameControler.move(new Coord(0,0), new Coord(1,0));
		
		System.out.print("\n Déplacement de 3,6 vers 3,4 = ");
		System.out.print(chessGameControler.move(new Coord(3,6), new Coord(3, 4)));	// true
		...
		System.out.print(chessGameControler.move(new Coord(3,4), new Coord(3, 6)));	// false 

		System.out.print("\n Déplacement de 4,1 vers 4,3 = ");
		System.out.print(chessGameControler.move(new Coord(4, 1), new Coord(4, 3)));	// true

		System.out.print("\n Déplacement de 3,4 vers 3,4 = ");
		System.out.print(chessGameControler.move(new Coord(3, 4), new Coord(3, 4)));	// false

		System.out.print("\n Déplacement de 3,4 vers 4,3 = ");
		System.out.print(chessGameControler.move(new Coord(3, 4), new Coord(4, 3)));	// true		
